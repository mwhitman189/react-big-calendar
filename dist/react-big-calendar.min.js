!(function(e, t) {
  ...
  var Ss = { display: 'flex', flexDirection: 'column' },
    ...
    Os = function(e) {
      ...
      return r.createElement(
        ...
        0 !== n && r.createElement('p', { style: Ds }, n)
      )
    }
  Os.propTypes = {}
  var Ms = (function(e) {
  ...
  var Ts = (function(e) {
    ...
    var n = t.prototype
    return (
      (n.renderHeaderCells = function(e, t) {
        var n = this.props,
          o = n.accessors,
          i = n.displayOthersColumn,
          a = n.components.resourceHeader,
          s = void 0 === a ? Os : a,
          c = new Date().getMonth(),
          l = t.getMonth() === c ? t.getDate().toString() : 0
        return r.createElement(
          'div',
          ...
          e.map(function(e, t) {
            ...
            return (
              ...
              r.createElement(
                ...
                r.createElement(s, {
                  index: t,
                  title: o.resourceTitle(i),
                  mins: i.minsByDate ? i.minsByDate[l] : 0,
                  resource: i,
                })
              )
            )
    ...
    return (
      ...
      (o.renderEvents = function(e, t, n, o, i) {
        var s = this,
          ...
          v = c.displayOthersColumn,
          g = this.memoizedResources(this.props.resources, p),
          y = g.groupEvents(t, i),
          b = function(e, t, n, o, c, m, g) {
            var b = (y.get(o) || []).filter(function(e) {
                return xe(t, p.start(e), p.end(e), 'day')
              }),
              w = (y.get('other') || []).filter(function(e) {
                return xe(t, p.start(e), p.end(e), 'day')
              })
            return r.createElement(
              r.Fragment,
        ...
        if (m) {
          ...
          return e.map(function(e, t) {
            return g.map(function(r, o) {
              var a = r[0],
                s = r[1]
              return !i.includes(a) && b(n, e, t, a, s, o, w === o + 1)
            })
          })
        }
        return g.map(function(t, r) {
          var o = t[0],
            i = t[1]
          return e.map(function(e, t) {
            return b(n, e, t, o, i, r)
          })
        })
      }),
      (o.render = function() {
          ...
          r.createElement(
            ...
            g
              ? r.createElement(Ts, {
                  ...
                  partTimeResourceIds: D,
                  displayOthersColumn: y,
                })
              : r.createElement(Ms, {
                  range: n,
                  events: E,
